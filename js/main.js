...
(function() {
  $(function() {
    var arrayEqual, boardEqual, boardIsFull, buildBoard, changeColor, collapseCells, gameLost, gameWon, generateTile, getColumn, getRandomCellIndecies, getRow, mergeCells, move, moveIsValid, noValidMoves, ppArray, randomIndex, randomValue, setColumn, setRow, showBoard;
    ...
    changeColor = function(rgba, x, y) {
      return $(".r" + x + ".c" + y).css("background-color", "" + rgba);
    };
    showBoard = function(board) {
      var rgba, temp, x, y, _i, _results;
      _results = [];
      for (x = _i = 0; _i <= 3; x = ++_i) {
        _results.push((function() {
          ...
          for (y = _j = 0; _j <= 3; y = ++_j) {
            if (board[x][y] !== 0) {
              ...
              rgba = "rgb(0," + temp + ",12)";
              _results1.push(changeColor(rgba, x, y));
            } else {
              $(".r" + x + ".c" + y + " > div").html(' ');
              $(".r" + x + ".c" + y + " > div").html(board[x][y]);
              temp = 0;
